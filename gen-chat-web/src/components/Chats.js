                ...
                <div className='flex items-center justify-between gap-4 '>
                  <div className=''></div>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6" onClick={async () => {
                      ...
                      console.log("-------------------");
                      console.log({ id: user.phoneNumber, calleeId: currentFriend.phoneNumber, token: token.data, request: "call"});

                      navigate("/CallScreen", { state: {id: user.phoneNumber, calleeId: currentFriend.phoneNumber, token: token.data, request: "call"} });
                    }}>
                    ...
                    <dialog id="my_modal_Call" className="modal">
                      <div className="card card-compact w-80 bg-base-100 shadow-xl">
                        <form method="dialog">
                          <button id='close_call' className="btn btn-sm btn-circle btn-ghost absolute right-2 top-2">✕</button>
                        </form>
...

              {
                isExistUserInGroup() ?
                  ...
                  <div className='flex items-center p-5 gap-7 justify-around'>
                    <p className='text-xl text-red-400'>You had been kicked out of this group</p>
                  </div>
              }
            </div>
