...
export default function OTP({ navigation }) {
    ...
    return ( <
        ...
        { /* <htmlForm action="http://localhost:6969/users/login" method="POST"> */ } { /* <!-- Phone Number Input --> */ } <
        div className = "mb-4" >
        <
        label htmlFor = "phoneNumber"
        className = "block text-gray-600" > Please enter the OTP that we send to this phone number < /label> <
        input type = "tel"
        id = "phoneNumber"
        name = "phoneNumber"
        ...
        <
        a href = "/"
        className = "hover:underline" > Return to Main page < /a> <
        /div>
        ...
        <
        p href = "/"
        className = "hover:underline" > { errors.error } < /p> <
        /div>
        ...
        <
        p href = "/"
        className = "hover:underline" > { alerts.alert } < /p> <
        /div>

        <
        div id = 'recaptcha-container' > < /div> { /* </htmlForm> */ } <
        /div>
    )
}