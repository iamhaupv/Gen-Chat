...
import { StyledValueToCSSObject, themeStyledValueToCSSObject } from './StyledValueToCSSObject';
export function sxToSXResolved(sx, path = [], meta, CONFIG, shouldResolve = true) {
  ...
  const resolvedThemeCSSStyle = shouldResolve ? themeStyledValueToCSSObject(sx === null || sx === void 0 ? void 0 : sx.style, CONFIG) : sx === null || sx === void 0 ? void 0 : sx.style;
