...
export function resolveStyledPropsRecursively(theme = {}, path = [], sxVerbosed = {}, breakpoint = '') {
...
export function convertStyledToStyledVerbosed(theme) {
...
export function convertSxToSxVerbosed(sx) {
  if (!sx) return {};
