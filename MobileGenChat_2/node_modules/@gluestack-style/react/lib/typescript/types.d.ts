...
export type ThemeStyles<IToken> = Partial<{
    [key: string]: {
        [key in keyof IToken]?: {
            [k in `${keyof IToken[key]}`]?: `$${key}$${keyof IToken[key]}` | (String & {}) | number;
        };
    };
}>;
...
export type SxProps<GenericComponentStyles = AliasesProps, Variants = unknown, GenericComponentProps = unknown, PLATFORM = '', MediaQuery = '', PluginType = []> = Partial<StylePropsType<GenericComponentStyles, PLATFORM> & PassingPropsType<GenericComponentStyles, Variants, GenericComponentProps, MediaQuery, PluginType>> | (Partial<PluginPropsType<PluginType, GenericComponentProps, GenericComponentStyles, PLATFORM>> & {
    ...
    [Key in `.${GlobalThemes}`]?: SxProps<GenericComponentStyles, Variants, GenericComponentProps, PLATFORM, MediaQuery, PluginType> & PassingPropsType<GenericComponentStyles, Variants, GenericComponentProps, MediaQuery, PluginType> & Partial<{
        [key: string]: any;
    }>;
} & {
    [Key in `.${string}`]?: SxProps<GenericComponentStyles, Variants, GenericComponentProps, PLATFORM, MediaQuery, PluginType> & PassingPropsType<GenericComponentStyles, Variants, GenericComponentProps, MediaQuery, PluginType> & Partial<{
        [key: string]: any;
    }>;
} & {
...
export type StyledComponentProps<GenericComponentStyles, Variants, P, ComCon> = Omit<'sx' extends keyof P ? P & VariantProps<Variants, ComCon> : Partial<Omit<P & ComponentProps<GenericComponentStyles, Variants, P> & VariantProps<Variants, ComCon> & UtilityProps<GenericComponentStyles, Variants, P>, 'animationComponentGluestack'>>, 'animationComponentGluestack'>;
export type GluestackComponent<GenericComponentStyles, Variants, P, ComCon> = ForwardRefExoticComponent<StyledComponentProps<GenericComponentStyles, Variants, P, ComCon>>;
export type VariantProps<Variants, ComCon> = GSConfig['globalStyle'] extends object ? {
...
export type ComponentProps<GenericComponentStyles, Variants, P> = SxStyleProps<GenericComponentStyles, Variants, P, 'animationComponentGluestack' extends keyof P ? P['animationComponentGluestack'] extends true ? Plugins : [] : []> & {
    states?: {
        [K in IState]?: boolean;
    };
    as?: any;
};
export type VerbosedUtilityProps<GenericComponentStyles, VariantProps, GenericComponentProps> = {
    [key in `$${IState}`]: SxProps<GenericComponentStyles, VariantProps, GenericComponentProps>;
} & {
    [key in `$${PLATFORMS}`]?: SxProps<GenericComponentStyles, VariantProps, GenericComponentProps>;
} & {
    [key in `$${IMediaQueries}`]?: SxProps<GenericComponentStyles, VariantProps, GenericComponentProps>;
} & {
    [key in `$_${string}`]?: SxProps<RNStyledProps, VariantProps, GenericComponentProps>;
};
type Permutations<T extends string, U extends string | ''> = T extends any ? U extends '' ? T : `$${T}-${Permutations<Exclude<U, T>, ''>}` : never;
...
type LastPart<T extends string> = T extends `${string}-${infer Rest}` ? LastPart<Rest> : T;
export type UtilityPropsCombinations<Props extends string> = StatePropsCombination<Props> | PlatformPropsCombination<Props> | MediaQueryCombination<Props> | ColorModeCombination<Props> | ThemeCombination<Props>;
export type UtilityProps<GenericComponentStyles, Variants, GenericComponentProps> = Omit<TokenizedRNStyleProps<GetRNStyles<GenericComponentStyles>>, keyof GenericComponentProps> & Omit<AliasesProps<GetRNStyles<GenericComponentStyles>>, keyof GenericComponentProps> & Partial<{
    [key in UtilityPropsCombinations<Extract<keyof GetRNStyles<GenericComponentStyles>, string>>]?: LastPart<key> extends keyof PropertyTokenType ? PropertyTokenType[LastPart<key>] extends 'sizes' ? key extends `$web-${string}` ? WithSizeNegativeValue<GSConfig['tokens']> | (string & {}) : WithSizeNegativeValue<GSConfig['tokens']> | ExtendRNStyle<GenericComponentStyles, LastPart<key>> : PropertyTokenType[LastPart<key>] extends 'space' ? key extends `$web-${string}` ? WithNegativeValue<StringifyToken<keyof GSConfig['tokens'][PropertyTokenType[LastPart<key>]]>> | (string & {}) : WithNegativeValue<StringifyToken<keyof GSConfig['tokens'][PropertyTokenType[LastPart<key>]]>> | ExtendRNStyle<GetRNStyles<GenericComponentStyles>, LastPart<key>> : PropertyTokenType[LastPart<key>] extends keyof GSConfig['tokens'] ? key extends `$web-${string}` ? (string & {}) | StringifyToken<keyof GSConfig['tokens'][PropertyTokenType[LastPart<key>]]> | ExtendRNStyle<GetRNStyles<GenericComponentStyles>, LastPart<key>> : StringifyToken<keyof GSConfig['tokens'][PropertyTokenType[LastPart<key>]]> | ExtendRNStyle<GetRNStyles<GenericComponentStyles>, LastPart<key>> : LastPart<key> extends keyof GetRNStyles<GenericComponentStyles> ? GetRNStyles<GenericComponentStyles>[LastPart<key>] : never : LastPart<key> extends keyof GetRNStyles<GenericComponentStyles> ? GetRNStyles<GenericComponentStyles>[LastPart<key>] : never;
}> & Partial<{
    [key in UtilityPropsCombinations<keyof Aliases>]?: LastPart<key> extends keyof Aliases ? Aliases[LastPart<key>] extends keyof GetRNStyles<GenericComponentStyles> ? PropertyTokenType[Aliases[LastPart<key>]] extends 'sizes' ? key extends `$web-${string}` ? (string & {}) | WithSizeNegativeValue<GSConfig['tokens']> | ExtendRNStyle<GetRNStyles<GenericComponentStyles>, Aliases[LastPart<key>]> : WithSizeNegativeValue<GSConfig['tokens']> | ExtendRNStyle<GetRNStyles<GenericComponentStyles>, Aliases[LastPart<key>]> : PropertyTokenType[Aliases[LastPart<key>]] extends 'space' ? key extends `$web-${string}` ? (string & {}) | WithNegativeValue<StringifyToken<keyof GSConfig['tokens'][PropertyTokenType[Aliases[LastPart<key>]]]>> | ExtendRNStyle<GetRNStyles<GenericComponentStyles>, Aliases[LastPart<key>]> : WithNegativeValue<StringifyToken<keyof GSConfig['tokens'][PropertyTokenType[Aliases[LastPart<key>]]]>> | ExtendRNStyle<GetRNStyles<GenericComponentStyles>, Aliases[LastPart<key>]> : key extends `$web-${string}` ? (string & {}) | StringifyToken<keyof GSConfig['tokens'][PropertyTokenType[Aliases[LastPart<key>]]]> | ExtendRNStyle<GetRNStyles<GenericComponentStyles>, Aliases[LastPart<key>]> : StringifyToken<keyof GSConfig['tokens'][PropertyTokenType[Aliases[LastPart<key>]]]> | ExtendRNStyle<GetRNStyles<GenericComponentStyles>, Aliases[LastPart<key>]> : never : any;
}> & Partial<VerbosedUtilityProps<GenericComponentStyles, Variants, GenericComponentProps>>;
/********************* UTILITY TYPE *****************************************/
...
export type GetRNStyles<GenericComponentStyles> = UnionToIntersection<Partial<Exclude<GenericComponentStyles, undefined | null | false | string | number | any[]>>>;
...
export type IWrapperType = 'global' | 'forwarded-base' | 'forwarded-descendant-base' | 'forwarded-variant' | 'forwarded-descendant-variant' | 'boot-base' | 'boot-base-state' | 'boot-descendant-base' | 'boot-descendant-base-state' | 'boot-variant' | 'boot-variant-state' | 'boot-descendant-variant' | 'boot-descendant-variant-state' | 'extended-base' | 'extended-base-state' | 'extended-descendant-base' | 'extended-descendant-base-state' | 'extended-variant' | 'extended-variant-state' | 'extended-descendant-variant' | 'extended-descendant-variant-state' | 'composed-base' | 'composed-base-state' | 'composed-descendant-base' | 'composed-descendant-base-state' | 'composed-variant' | 'composed-variant-state' | 'composed-descendant-variant' | 'composed-descendant-variant-state' | 'passing-base' | 'inline-base' | 'inline-variant' | 'inline-descendant-base' | 'inline-base-state';
