...
export type IToolTipComponentType<StyledTooltip, StyledTooltipContent, StyledTooltipText> = React.ForwardRefExoticComponent<StyledTooltip & React.RefAttributes<StyledTooltip> & ITooltipProps> & {
    Content: React.ForwardRefExoticComponent<StyledTooltipContent & React.RefAttributes<StyledTooltipContent>>;
    Text: React.ForwardRefExoticComponent<StyledTooltipText & React.RefAttributes<StyledTooltipText>>;
};
