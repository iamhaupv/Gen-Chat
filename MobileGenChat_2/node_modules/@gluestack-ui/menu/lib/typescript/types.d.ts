...
export type IMenuComponentType<Root, Item, Label> = React.ForwardRefExoticComponent<React.RefAttributes<Root> & Root & IMenuProps> & {
    Item: React.ForwardRefExoticComponent<React.RefAttributes<Item> & Item & ItemProps<Item> & IItemProp>;
    ItemLabel: React.ForwardRefExoticComponent<React.RefAttributes<Label> & Label>;
};
