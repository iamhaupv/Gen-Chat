...
export type IAlertDialogComponentType<StyledAlertDialog, StyledAlertDialogContent, StyledAlertDialogCloseButton, StyledAlertDialogHeader, StyledAlertDialogFooter, StyledAlertDialogBody, StyledAlertDialogBackdrop> = React.ForwardRefExoticComponent<React.RefAttributes<StyledAlertDialog> & StyledAlertDialog & IAlertDialogProps> & {
    Content: React.ForwardRefExoticComponent<React.RefAttributes<StyledAlertDialogContent> & StyledAlertDialogContent>;
    CloseButton: React.ForwardRefExoticComponent<React.RefAttributes<StyledAlertDialogCloseButton> & StyledAlertDialogCloseButton>;
    Header: React.ForwardRefExoticComponent<React.RefAttributes<StyledAlertDialogHeader> & StyledAlertDialogHeader>;
    Footer: React.ForwardRefExoticComponent<React.RefAttributes<StyledAlertDialogFooter> & StyledAlertDialogFooter>;
    Body: React.ForwardRefExoticComponent<React.RefAttributes<StyledAlertDialogBody> & StyledAlertDialogBody>;
    Backdrop: React.ForwardRefExoticComponent<React.RefAttributes<StyledAlertDialogBackdrop> & StyledAlertDialogBackdrop>;
};
