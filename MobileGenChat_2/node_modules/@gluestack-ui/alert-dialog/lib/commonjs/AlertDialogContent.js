...
const AlertDialogContent = (StyledAlertDialogContent, AnimatePresence) => /*#__PURE__*/(0, _react.forwardRef)(({
  children,
  ...props
}, ref) => {
  const {
  ...
  return /*#__PURE__*/_react.default.createElement(_focus.FocusScope, {
    ...
    exit: true,
    "aria-modal": "true",
    role: _reactNative.Platform.OS === 'web' ? 'alertdialog' : undefined,
    accessibilityViewIsModal: true,
    tabIndex: _reactNative.Platform.OS === 'web' ? -1 : undefined
  }, dialogProps), children)));
});
var _default = exports.default = AlertDialogContent;
