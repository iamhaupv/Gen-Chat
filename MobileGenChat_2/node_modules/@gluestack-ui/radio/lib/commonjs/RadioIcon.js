...
const RadioIcon = StyledRadioIcon => /*#__PURE__*/(0, _react.forwardRef)(({
  children,
  ...props
}, ref) => {
  const {
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, isChecked && /*#__PURE__*/_react.default.createElement(StyledRadioIcon, _extends({
    states: {
      checked: isChecked,
      disabled: isDisabled,
