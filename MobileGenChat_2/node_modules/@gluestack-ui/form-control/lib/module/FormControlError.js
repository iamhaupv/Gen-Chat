...
const FormControlError = StyledFormControlError => /*#__PURE__*/forwardRef(({
  children,
  ...props
}, ref) => {
  ...
  React.useEffect(() => {
    remainingProps === null || remainingProps === void 0 || remainingProps.setHasFeedbackText(true);
    return () => {
      remainingProps === null || remainingProps === void 0 || remainingProps.setHasFeedbackText(false);
    };
  });
