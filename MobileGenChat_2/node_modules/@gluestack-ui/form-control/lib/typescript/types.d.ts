...
export type IFormControlComponentType<Root, Error, ErrorText, ErrorIcon, Label, LabelText, _LabelAstrick, Helper, HelperText> = React.ForwardRefExoticComponent<Root & InterfaceFormControlProps> & {
