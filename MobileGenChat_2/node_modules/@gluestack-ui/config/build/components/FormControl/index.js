...
const StyledErrorIcon = styled(AsForwarder, {
    color: '$error700',
    // @ts-ignore
    fill: 'none',
    variants: {
...
//   },
// });
const StyledFormControlErrorText = styled(Text, {
    color: '$error700',
...
const StyledFormControlHelperText = styled(Text, {
    props: {
        size: 'xs',
    },
    color: '$text500',
}, { ancestorStyle: ['_helperText'] });
const StyledFormControlLabel = styled(View, {
    flexDirection: 'row',
    justifyContent: 'flex-start',
    alignItems: 'center',
    mb: '$1',
