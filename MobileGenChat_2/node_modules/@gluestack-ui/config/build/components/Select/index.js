...
import { AnimatePresence, AnimatedPressable, AnimatedView, } from '@gluestack-style/animation-resolver';
...
const StyledContent = styled(AnimatedView, {
    alignItems: 'center',
...
const StyledIcon = styled(AsForwarder, {
    variants: {
        size: {
            '2xs': {
                h: '$3',
...
const StyledSelectTrigger = styled(Pressable, {
    'borderWidth': 1,
...
const StyledSelectInput = styled(TextInput, {
    _web: {
        w: '$full',
    },
    pointerEvents: 'none',
