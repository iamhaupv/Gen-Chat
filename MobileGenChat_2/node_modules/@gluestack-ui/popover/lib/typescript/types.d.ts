...
export type IPopoverComponentType<PopoverProps, ArrowProps, ContentProps, HeaderProps, FooterProps, BodyProps, BackdropProps, CloseButtonProps> = React.ForwardRefExoticComponent<IPopoverProps & PopoverProps & React.RefAttributes<PopoverProps>> & {
    Body: React.ForwardRefExoticComponent<BodyProps & React.RefAttributes<BodyProps>>;
    CloseButton: React.ForwardRefExoticComponent<CloseButtonProps & React.RefAttributes<CloseButtonProps>>;
    Content: React.ForwardRefExoticComponent<ContentProps & React.RefAttributes<ContentProps>>;
    Footer: React.ForwardRefExoticComponent<FooterProps & React.RefAttributes<FooterProps>>;
    Header: React.ForwardRefExoticComponent<HeaderProps & React.RefAttributes<HeaderProps>>;
    Arrow: React.ForwardRefExoticComponent<ArrowProps & React.RefAttributes<ArrowProps>>;
    Backdrop: React.ForwardRefExoticComponent<BackdropProps & React.RefAttributes<BackdropProps>>;
};
