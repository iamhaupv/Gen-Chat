...
export type IInputComponentType<Root, Icon, Slot, Input> = React.ForwardRefExoticComponent<React.RefAttributes<Root> & Root & IInputFieldProps> & {
    ...
    Input: React.ForwardRefExoticComponent<React.RefAttributes<Input> & Input & IInputProps>;
};
