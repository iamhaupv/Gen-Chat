...
const ModalBackdrop = (StyledModalBackdrop, AnimatePresence) => /*#__PURE__*/(0, _react.forwardRef)(({
  children,
  ...props
}, ref) => {
  const {
  ...
  }, /*#__PURE__*/_react.default.createElement(StyledModalBackdrop, _extends({
    ref: ref,
    exit: true,
    onPress: () => {
