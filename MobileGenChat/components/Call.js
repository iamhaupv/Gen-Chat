...
import { Phone, PhoneCall, PhoneOutgoing, UserPlus, Video } from 'lucide-react-native';
              ...
              <HStack space="lg" alignItems='center'>
                ...
                <VStack style={{
                  ...
                  <Text color="$coolGray800"
                    fontWeight="$bold"
                    $dark-color="$warmGray100"
                    fontSize='$sm'>10:00</Text>
                  </VStack>

                </VStack>
                <Icon as={PhoneCall} size='30' color='green'/>
                <Icon as={PhoneOutgoing} size='30' color='red'/>
              </HStack>
            </Box>
          </TouchableHighlight>
        )}
